...
<body class="gray-bg">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveEmp.htm" enctype="multipart/form-bata">
	...
	function initEditUser(getSelection){
		...
		$('#hobby1').attr('checked',getSelection.hobby.indexOf('篮球')!=-1);
		$('#hobby2').attr('checked',getSelection.hobby.indexOf('足球')!=-1);
		$('#hobby3').attr('checked',getSelection.hobby.indexOf('排球')!=-1);
