					...
					<form id="form_user" method="post" action="reserveUser.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>员工生日：</td>
								<td><input placeholder="开始时间" id="txt_search_birthday" name="birthday" class="laydate-icon form-control layer-date"/></td>
							</tr>
							<tr>
								<td>员工性别：</td>
								<td>
							...
							<tr>
								...
								<td>爱好：</td>
								<td>
								<input type="checkbox" id="hobby1" name="hobby" aria-required="true" required value="足球"/>足球
								<input type="checkbox" id="hobby2" name="hobby" aria-required="true" required value="篮球"/>篮球
								<input type="checkbox" id="hobby3" name="hobby" aria-required="true" required value="橄榄球"/>橄榄球
								</td>
							</tr>
							<tr>
								<td>员工部门：</td>
